...
<div class="container py-5">
    ...
    <a href="<?php echo $lienRetour; ?>" class="btn-back">← Retour</a>
            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label fw-bold text-success">Stock (Qté)</label>
                            <input type="number" name="stock" class="form-control fw-bold" value="<?php echo $menu['quantite_restante']; ?>" min="0" required style="border-color: #198754;">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="conditions" class="form-control" rows="2"><?php echo htmlspecialchars($menu['conditions'] ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="image-upload-zone p-2">
                            <input type="hidden" name="old_image_principale" value="<?php echo $menu['image_principale']; ?>">
                    ...
                    <div class="upload-grid">
                        <div class="mini-upload-zone" style="height:auto;">
                            <input type="hidden" name="old_image_entree" value="<?php echo $menu['image_entree']; ?>">
                            <small>ENTRÉE</small>
                            <input type="file" name="image_entree" class="form-control form-control-sm mt-2">
                        </div>
                        <div class="mini-upload-zone" style="height:auto;">
                            <input type="hidden" name="old_image_plat" value="<?php echo $menu['image_plat']; ?>">
                            <small>PLAT</small>
                            <input type="file" name="image_plat" class="form-control form-control-sm mt-2">
                        </div>
                        <div class="mini-upload-zone" style="height:auto;">
                            <input type="hidden" name="old_image_dessert" value="<?php echo $menu['image_dessert']; ?>">
                            <small>DESSERT</small>
